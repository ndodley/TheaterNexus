...
import { useTheater } from '../../hooks/theaters/useTheaters'
import { useTheaterShowtimes } from '../../hooks/showtimes/useTheaterShowtimes'
...
export default function TheaterShowtimesPage() {
  ...
  const { theaterId, theater, loading: theaterLoading, error: theaterError } = useTheater()
  ...
  const {
    ...
    initialLoading: showtimesInitialLoading,
    error: showtimesError,
    favoriteIds,
    toggleFavorite,
    groupedByMovie,
  } = useTheaterShowtimes(theaterId, { q, upcoming, order, timeRange, mpa, selectedDate })
  ...
  const loading = theaterLoading || showtimesLoading
  const initialLoading = theaterLoading || showtimesInitialLoading
  const error = theaterError || showtimesError

  if (initialLoading) return <section className="container"><div className="card">Loading theater showtimes…</div></section>
